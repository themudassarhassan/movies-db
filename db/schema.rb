...
ActiveRecord::Schema[7.0].define(version: 2023_11_10_093014) do
  ...
  add_foreign_key "watched_movies", "movies", on_delete: :cascade
  add_foreign_key "watched_movies", "users", on_delete: :cascade
end
